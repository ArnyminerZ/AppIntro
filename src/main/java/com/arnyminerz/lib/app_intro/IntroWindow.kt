...
fun IntroWindow(
    ...
    fabContainerColor: Color = MaterialTheme.colorScheme.primaryContainer,
    fabContentColor: Color = MaterialTheme.colorScheme.onPrimaryContainer,
    finishListener: () -> Unit,
) {
    ...
    @Suppress("UNCHECKED_CAST") val currentValue = page.action.value as Value<Any?>
    val currentValueState: Any? by currentValue.value
        ...
        floatingActionButton = {
            FloatingActionButton(
                ...
                onClick = {
                    ...
                    if (currentValueState as? Boolean == true && permissionsState?.allPermissionsGranted == false)
                ...
                if (currentValueState as? Boolean == true && permissionsState?.allPermissionsGranted != true) {
                    if (blockPage < 0) {
